...
enum ChangelogStore {
    ...
    static let logs: [VersionLog] = [
        ...
        VersionLog(
            ...
            features: [
                "播放器设置整合「布局」板块：自定义底部布局、底部指示线、歌词对齐合并到一处，排版更紧凑",
                "底栏默认布局优化：进度条下移 22、控制按钮下移 22 并放大至 1.15、指示线下移 34，观感更协调",
            ],
            fixes: []
        ),
        VersionLog(
            id: "1.9.10-r",
            version: "1.9.10",
            title: "恢复 1.9.10 · 刷抖音切歌动画 · 网易云登录自动收起",
            features: [
                "恢复 1.9.10 版本全部功能与界面样式",
                "刷抖音式切歌动画：播放页上下滑动切歌时，封面先向滑动方向飞出、新封面从对侧滑入，过渡更顺滑；滑动与封面点击互斥，不再误触跳转歌词页",
