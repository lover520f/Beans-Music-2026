...
enum ChangelogStore {
    ...
    static let logs: [VersionLog] = [
        VersionLog(
            id: "1.9.11",
            version: "1.9.11",
            title: "刷抖音切歌 · 歌词模糊开放 · 悬浮窗实时调节",
            features: [
                "刷抖音式切歌：专辑界面上下滑动即可像刷视频一样切歌（上滑下一首、下滑上一首），带封面飞出 / 滑入过渡动画",
                "歌词模糊开放更多：模糊起始距离范围放开到 0~10 行，配合强度可调出更柔和的渐隐效果",
                "修复播放器上滑切歌时误触封面跳转歌词页：滑动改为与封面点击互斥的手势",
                "布局调整升级为悬浮窗实时预览：歌词字号 / 显示多少 / 对齐 / 模糊 / 发光滑杆始终显示，边调边看不再只有一个进度条样式",
                "播放器设置整合为「播放 / 歌词显示 / 歌词效果 / 布局 / 封面」五大板块",
